...
import { BotaoUm, Box, CardScrool, MinisterioCasais, MinisterioInter, MinisterioJovens, MinisterioLouvor, MinisterioMidia, MinisterioMissoes, MinisterioUm } from "../../styles/Ministerios/styles";
