...
import fotoLideresMissoes from "../../../assets/LideresMinisterios/MinisteriosGuaianases/missoes.jpg";
import fotoLideresIntercessao from "../../../assets/LideresMinisterios/MinisteriosGuaianases/intercessao.jpg";
                ...
                <Grid container spacing={2} alignItems={"center"}>
                    ...
                    <Grid item xs={7} md={9}>
                        <p>
                            ...
                            <AlertDialogSlide titulo={missoes[0]} texto={missoes[1]} fotoLider1={missoes[2]} nomeLider1={missoes[3]} ></AlertDialogSlide>
                        </p>
                    </Grid>
                    <Grid item xs={7} md={9}>
                        <p>
                            ...
                            <AlertDialogSlide titulo={jovens[0]} texto={jovens[1]} fotoLider1={jovens[2]} nomeLider1={jovens[3]} fotoLider2={jovens[4]} nomeLider2={jovens[5]}></AlertDialogSlide>
                        </p>
                    </Grid>
                    <Grid item xs={5} md={3}>
                        <img src={imagem} />
                    ...
                    <Grid item xs={7} md={9}>
                        <p>
                            ...
                            <AlertDialogSlide titulo={midias[0]} texto={midias[1]} fotoLider1={midias[2]} nomeLider1={midias[3]} ></AlertDialogSlide>
                        </p>
                    </Grid>
                    <Grid item xs={7} md={9}>
                        <p>
                            ...
                            <AlertDialogSlide titulo={louvorDanca[0]} texto={louvorDanca[1]} fotoLider1={louvorDanca[2]} nomeLider1={louvorDanca[3]} fotoLider2={louvorDanca[4]} nomeLider2={louvorDanca[5]}></AlertDialogSlide>
                        </p>
                    </Grid>
                    <Grid item xs={5} md={3}>
                        <img src={imagem} />
                    ...
                    <Grid item xs={7} md={9}>
                        <p>
                            ...
                            <AlertDialogSlide titulo={intercessao[0]} texto={intercessao[1]} fotoLider1={intercessao[2]} nomeLider1={intercessao[3]} ></AlertDialogSlide>
                        </p>
                    </Grid>
                    <Grid item xs={7} md={9}>
                        <p>
